...
knitr::include_graphics("reference/figures/DataInputDiagram.png")
```
...
```{r,out.width="50%",echo = FALSE}
knitr::include_graphics("reference/figures/ChangeDetectionDiagram.pngChangeDetectionDiagram.png")
```
...
### Results
```{r,out.width="50%",echo = FALSE}
knitr::include_graphics("reference/figures/SummarizeResultsDiagram.png")
```
