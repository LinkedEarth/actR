...
knitr::include_graphics("docs/DataInputDiagram.png")
```
...
```{r,out.width="50%",echo = FALSE}
knitr::include_graphics("docs/ChangeDetectionDiagram.png")
```
...
### Results
```{r,out.width="50%",echo = FALSE}
knitr::include_graphics("docs/SummarizeResultsDiagram.png")
```
